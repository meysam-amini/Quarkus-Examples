...
public class CustomerResourceTest {
    ...
    public void getById() {
        ...
        Customer got = given()
                ...
                .statusCode(200)
                .extract().as(Customer.class);
        Assertions.assertThat(saved).isEqualTo(got);
    }
    ...
    public void post() {
        ...
        Customer saved = given()
                ...
                .statusCode(201)
                .extract().as(Customer.class);
        Assertions.assertThat(saved.getCustomerId()).isNotNull();
    }
    ...
    public void put() {
        ...
        Customer updated = given()
                ...
                .statusCode(200)
                .extract().as(Customer.class);
        Assertions.assertThat(updated.getFirstName()).isEqualTo("Updated");
    }
